...
class Session(ISession):
    ...
    def __init__(self):
        ...
        self._config = _config.Config(
            {
                "uninterested_call_strategy": _config.Enum(["fail", "warn", "ignore"], default="fail"),
                "expectation_class": _config.Type(Expectation, default=Expectation),
            }
        )
    ...
    def expectations(self):
        ...
        return itertools.chain(self._unordered_expectations, self._ordered_expectations)
