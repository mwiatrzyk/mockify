...
def test_when_mock_has_two_expectations_and_was_never_called__then_unsatisfied_is_raised(mock):
    ...
    for i in range(2):
        assert_attr_match(expectations[i],
...
def test_if_mock_has_same_action_recorded_twice_using_will_once_and_is_not_called__then_expected_call_count_is_two(mock):
