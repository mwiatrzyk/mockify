...
class TestObjectMockWithNegativeMaxDepth:

    @pytest.fixture
    def uut(self):
        return ObjectMock('uut', max_depth=-1)
...
class TestObjectMockWithMaxDepthSetToZero:

    @pytest.fixture
    def uut(self):
        return ObjectMock('uut', max_depth=0)
...
class TestObjectMockWithMaxDepthSetToOne:
...
class TestObjectMockWithMaxDepthSetToTwo:

    @pytest.fixture
    def uut(self):
        return ObjectMock('uut', max_depth=2)
