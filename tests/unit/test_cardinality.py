...
class TestActualCallCount:
    ...
    @pytest.mark.parametrize(
        'value, message', [
            (0, 'never called'), (1, 'called once'), (2, 'called twice'),
            (3, 'called 3 times'), (4, 'called 4 times')
        ]
    )
...
class TestExactly:
    ...
    @pytest.mark.parametrize(
        'value, message', [
            (0, 'to be never called'), (1, 'to be called once'),
            (2, 'to be called twice'), (3, 'to be called 3 times'),
    ...
    def test_when_mock_expected_to_be_called_twice_but_was_called_once__then_mock_is_not_satisfied(
        self
    ):
        mock = Mock('mock')
    ...
    def test_when_mock_expected_to_be_called_twice_and_was_called_twice__then_mock_is_satisfied(
        self
    ):
        mock = Mock('mock')
        mock.expect_call().times(2)
    ...
    def test_when_mock_expected_to_be_called_twice_and_was_called_3_times__then_mock_is_not_satisfied(
        self
    ):
        mock = Mock('mock')
        mock.expect_call().times(2)
    ...
    def test_when_repeated_action_expected_to_be_called_twice_and_was_called_once__then_mock_is_not_satisfied(
        self
    ):
        mock = Mock('mock')
    ...
    def test_when_repeated_action_expected_to_be_called_twice_and_was_called_three_times__then_mock_is_not_satisfied(
        self
    ):
        mock = Mock('mock')
        mock.expect_call().will_once(Return(1)).will_repeatedly(Return(2)
    ...
    def test_when_repeated_action_expected_to_be_called_twice_and_was_called_twice__then_mock_is_satisfied(
        self
    ):
        mock = Mock('mock')
        mock.expect_call().will_once(Return(1)).will_repeatedly(Return(2)
...
class TestAtLeast:
    ...
    def test_when_mock_is_expected_to_be_called_at_least_once_and_was_never_called__then_mock_is_not_satisfied(
        self
    ):
        mock = Mock('mock')
    ...
    def test_when_repeated_action_expected_to_be_called_at_least_once_and_never_called__then_mock_is_not_satisfied(
        self
    ):
        mock = Mock('mock')
    ...
    def test_expect_repeated_action_to_be_called_at_least_once_and_call_it_once(
        self
    ):
        mock = Mock('mock')
        mock.expect_call().will_repeatedly(Return(1)).times(AtLeast(1))
...
class TestAtMost:
    ...
    def test_if_called_with_zero__then_exactly_with_zero_equivalent_is_created(
        self
    ):
    ...
    @pytest.mark.parametrize(
        'value, message', [
            (0, 'to be never called'), (1, 'to be called at most once'),
    ...
    def test_when_mock_is_expected_to_be_called_at_most_twice_and_was_called_3_times__then_mock_is_not_satisfied(
        self
    ):
        mock = Mock('mock')
...
class TestBetween:
    ...
    def test_when_minimal_is_same_as_maximal__then_instance_of_exactly_object_is_created_instead(
        self
    ):
        uut = Between(1, 1)
    ...
    def test_when_expected_to_be_called_1_to_2_times_and_never_called__then_mock_is_not_satisfied(
        self
    ):
        mock = Mock('mock')
    ...
    def test_when_expected_to_be_called_1_to_2_times_and_called_3_times__then_mock_is_not_satisfied(
        self
    ):
        mock = Mock('mock')
        mock.expect_call().times(Between(1, 2))
    ...
    def test_expect_mock_to_be_called_between_1_and_2_times_and_call_it_once(
        self
    ):
        mock = Mock('mock')
        mock.expect_call().times(Between(1, 2))
    ...
    def test_expect_mock_to_be_called_between_1_and_2_times_and_call_it_twice(
        self
    ):
        mock = Mock('mock')
        mock.expect_call().times(Between(1, 2))
